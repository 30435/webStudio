...
<h3><a href="<?php echo $configInfos['getpwdUrl']; ?>" target="_blank">忘记密码</a></h3><h3><a href="register.php">注册</a></h3><h3><a href="<?php echo $configInfos['payUrl']; ?>" target="_blank">为游戏支付游戏币</a></h3>
</body>
</html>