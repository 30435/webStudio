...
class Job extends Custom_AdminController
{
	public function __construct()
	{
		parent::__construct();
		$this->_initCurrentModel('jobModel');
		...
		$this->operationMenus = array('spiderList', 'dealList', 'spiderContent', 'dealContent', 'askForce', 'spiderFile', 'copy', 'edit', 'delete');
	}
