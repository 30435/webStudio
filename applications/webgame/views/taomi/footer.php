...
<div id="footer">
	...
	<?php foreach (array(2, 3, 4, 19) as $showCatid) { ?>
		<a title="<?php echo $this->categoryInfos[$showCatid]['catname']; ?>" class="hgray" target="_blank" href="<?php echo $this->categoryInfos[$showCatid]['url']; ?>"><?php echo $this->categoryInfos[$showCatid]['catname']; ?></a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
	<?php } ?>
	</div>
