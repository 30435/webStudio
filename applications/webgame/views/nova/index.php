...
<div class="all">
	<div class="ban">
	<?php 
	if ($this->currentWebgameInfo['stop_webgame']) {
		echo '<img src="' . $this->staticUrl . 'cfont/images/tf.jpg" />';
	} else {
		echo '<iframe class="frm" src="' . $this->currentWebgameInfo['url_webgame'] . '" width="956" height="640" frameborder="0" scrolling="no"></iframe>';
	}
	?>
	</div>
		<div class="nav_nuowa">
