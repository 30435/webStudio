...
<div class="container bc ovh">
	...
	<iframe width="0" scrolling="no" height="0" frameborder="0" src="http://web2.17roco.qq.com/proxy.html" id="rocoproxy"></iframe>
    <div class="game bc">
        <div id="framecontent">
        	<iframe width="960" scrolling="no" height="560" frameborder="0" allowtransparency="true" src="http://g1.game.com/" id="mainiframe"></iframe>
        </div>
    </div>
	<div class="notice w976 bc pr tc">
        <div class="noticebox pa" id="newscon">
            <ul id="newscondiv">
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">合体机械出动 霹雳游侠来啦！</a></li>
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">新玩法洛克快打 重磅登场！</a></li>
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">VIP地下宫殿第四层开放 宠物、套装等你来拿！</a></li>
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">开学大作战 答题就能得称号和魔法装扮哦！</a></li>
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">玩具总动员机 械叮叮等你来兑换！</a></li>
			</ul>
            <ul id="newsdiv">
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">合体机械出动 霹雳游侠来啦！</a></li>
				<li><a target="_blank" href="http://roco.qq.com/webplat/info/news_version3/397/838/839/840/m682/201308/223283.shtml">新玩法洛克快打 重磅登场！</a></li>
    ...
    <div class="main pr bc ovh">
    	...
    	<div class="quick fl ovh">
        	<ul id="quickList" class="quicklist">
            	<li class="spr quick-a"><a title="进入官网" target="_blank" href="<?php echo $this->baseUrl; ?>/index/nova" class="spr ht q-home">进入官网</a></li>
        ...
        <div class="infor fl ovh">
            <a title="宠物大全" target="_blank" href="<?php echo $this->baseUrl; ?>index/category?catid=10" class="spr infor-a infor-a1 ht">诺瓦宠物</a>
            <a title="壁纸大全" target="_blank" href="<?php echo $this->baseUrl; ?>index/category?catid=16" class="spr infor-a infor-a2 ht">诺瓦图片</a>
            <a title="四格漫画" target="_blank" href="<?php echo $this->baseUrl; ?>index/category?catid15" class="spr infor-a infor-a3 ht">新手指南</a>
        </div>
    </div>
    ...
    <div class="footer pr">
        ...
        <div class="text">
            <p class="linklist">
            <a target="_blank" href="http://roco.qq.com/web201003/parents.shtml#1">关于洛克</a>|
            <a target="_blank" href="http://www.qq.com/contract.shtml">服务条款</a>|
            <a target="_blank" href="http://roco.qq.com/web201003/parents.shtml#3">家长须知</a>|
            <a target="_blank" href="http://roco.qq.com/web201003/parents.shtml#2">产品安全</a>|
            <a target="_blank" href="http://res.17roco.qq.com/download/install_flash_player_10_active_x.exe">下载flash播放器</a>|
            <a href="javascript:;" onclick="showhelp()">提问题，我帮你</a>
            </p>
            <p>&nbsp;Copyright &copy; 2010-2012 TENCENT. All Rights Reserved. &nbsp;ISBN号：978-7-89989-076-9</p>
            <p>&nbsp;抵制不良游戏&nbsp;拒绝盗版游戏&nbsp;注意自我保护&nbsp;谨防受骗上当&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;客服专线：0755-86013861<br>
            &nbsp;适度游戏益脑&nbsp;沉迷游戏伤身&nbsp;合理安排时间&nbsp;享受健康生活&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;本产品适合7-14岁儿童使用</p>
        </div>
    </div>
</div>

<div style="display: none; bottom: 37px;" id="question_box"></div> 
</body>
</html>