...
<link href="<?php echo $this->staticUrl; ?>webgame/common/css/comm/webtop.css" rel="stylesheet" type="text/css">
</head>
<body style="background:url(<?php echo $this->staticUrl; ?>webgame/common/images/bg_bar.gif?v=201308201554) repeat-x 0 32px #fff;" class="body_pt40">
...
<div id="header_4">
	<div class="top-container">
		<h1 style="position:relative;width:205px;height:40px;float:left;_zoom:1">
			<a title="<?php echo $this->metaDatas['title']; ?>" target="_blank" hidefocus="true" href="<?php echo $this->baseUrl; ?>" class="logo"><img width="205" height="34" src="<?php echo $this->staticUrl; ?>webgame/common/images/comm/topbar_v2012/2125logo_v0503.png"></a>
			<span style="clear:both;"></span>
		</h1>
		<span class="divide"></span>
		<a target="_blank" class="product-ad" href="/" onclick="pgvSendClick(4)"><img width="174" height="38" src="<?php echo $this->staticUrl; ?>webgame/common/images/ad.jpg" id="product-ad" style="display: inline;"></a>
