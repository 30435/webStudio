...
<script type="text/javascript" src="<?php echo $this->staticUrl; ?>common/crop/swfobject.js"></script>
<script>
			// 获取页面上的flash实例。
            ...
            var xiSwfUrlStr = "<?php echo $this->staticUrl; ?>common/crop/images/playerProductInstall.swf";
			
            var flashvars = {};
			// 图片地址
			flashvars.picurl = "<?php echo $$this->picurl; ?>";
			// 上传地址，使用了 base64 加密
			flashvars.uploadurl = "<?php echo base64_encode("index.php?m=attachment&c=attachments&a=crop_upload&module=$module&catid=$catid&file=".urlencode($this->picurl));?>";
            ...
            swfobject.embedSWF(
                "<?php echo $this->staticUrl; ?>common/crop/images/Main.swf", "flashContent", 
                "680", "480", 
        ...
        <div id="flashContent">
       	...
       	<noscript>
            <object classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" width="680" height="480" id="myFlashID">
                <param name="movie" value="<?php echo $this->staticUrl; ?>common/crop/images/Main.swf" />
                <param name="quality" value="high" />
                <param name="bgcolor" value="#ffffff" />
                <param name="allowScriptAccess" value="always" />
                <param name="allowFullScreen" value="true" />
                <!--[if !IE]>-->
                <object type="application/x-shockwave-flash" data="<?php echo $this->staticUrl; ?>common/crop/images/Main.swf" width="680" height="480">
                    <param name="quality" value="high" />
                    <param name="bgcolor" value="#ffffff" />
                    <param name="allowScriptAccess" value="always" />
                    <param name="allowFullScreen" value="true" />
