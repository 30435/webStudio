      ...
      <tbody>
		<tr>
		  ...
		  <div class="explain-col">
			...
			</script>-<input type="text" readonly="" class="date input-text" size="10" value="2013-01-29" id="end_time" name="end_time">&nbsp;
			<script type="text/javascript">
				Calendar.setup({
				weekNumbers: true,
				inputField : "end_time",
    ...
    <table width="100%" cellspacing="0">
      <thead>
		<tr>
		  ...
		  <th width="10%"><?php echo $this->fieldInfos['app_code']['name']; ?></th>
		  <th width="10%" align="center"><?php echo $this->fieldInfos['catid']['name']; ?></th>
		  <th width="10%" align="center"><?php echo $this->fieldInfos['contentid']['name']; ?></th>
		  <th width="10%" align="center"><?php echo $this->fieldInfos['file_name']['name']; ?></th>
		  <th width="5%" align="center"><?php echo $this->fieldInfos['file_size']['name']; ?></th>
		  <th width="10%"><?php echo $this->fieldInfos['uploadtime']['name']; ?></th>
		  <th width="10%"><?php echo $this->fieldInfos['uploadip']['name']; ?></th>
	  ...
	  <?php if (is_array($this->infos) && !empty($this->infos)) { foreach ($this->infos as $info) { ?>
        <tr>
          ...
          <td width="10%" align="center"><?php echo $info['app_code']; ?></td>
		  <td width="10%" align="center"><?php echo $info['catid']; ?></td>
		  <td width="10%" align="center"><?php echo $info['contentid']; ?></td>
		  <td width="10%" align="center"><?php echo $info['file_name']; ?></td>
		  <td width="10%" align="center"><?php echo $info['file_size']; ?></td>
		  <td width="10%" align="center"><?php echo $info['uploadip']; ?></td>
		  <td width="10%" align="center"><?php echo $info['uploadtime']; ?></td>
          <td class="text-c">
