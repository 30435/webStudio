...
class LinkurlModel extends CommonModel 
{
	...
	protected function _fieldInfos()
	{
		...
		$fieldInfos['fields'] = array(
			'id' => array('name' => '友链ID'),			
			'type' => array('name' => '友链类型', 'infos' => $typeInfos),
			...
			'status' => array('name' => '状态', 'infos' => array('0' => '<font class="red">未通过</font>', '1' => '<font class="green">通过</font>')),
			'add_time' => array('name' => '添加时间'),
		);
		$fieldInfos['fieldList'] = array('id', 'name', 'type', 'url', 'logo', 'listorder', 'add_time', 'description', 'status');
		$fieldInfos['fieldChanges'] = array('name', 'type', 'url', 'logo', 'listorder', 'add_time', 'description', 'status');
