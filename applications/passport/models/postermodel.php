...
class PosterModel extends CommonModel 
{
	...
	protected function _fieldInfos()
	{
		...
		$fieldInfos['fields'] = array(
			...
			'ad_type' => array('name' => '广告类型', 'infos' => $typeInfos),
			...
			'ad_status' => array('name' => '状态', 'infos' => array('0' => '<font class="red">终止</font>', '1' => '<font class="green">正常</font>')),
			'url' => array('name' => '广告链接'),
			'pic' => array('name' => '资源地址'),
			'url_ext' => array('name' => '广告链接2'),
			'pic_ext' => array('name' => '资源地址2'),
		);
		$fieldInfos['fieldList'] = array('id', 'name', 'ad_type', 'space_id', 'url', 'start_time', 'end_time', 'listorder', 'ad_status');
		$fieldInfos['fieldChanges'] = array('name', 'ad_type', 'space_id', 'url', 'url_ext', 'add_time', 'start_time', 'end_time', 'listorder', 'ad_status', 'pic', 'pic_ext');
