...
class Config extends Custom_AdminController
{
	...
	{
		parent::__construct();
		$this->configPayKeys = array('passport_register_open', 'passport_close_url', 'passport_open');
	}
	...
	public function change()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			$data = "<?php\r\n return "
				...
				. ";\r\n?>";
			@file_put_contents($this->appInfos[APPCODE]['path'] . 'config/config_passport.php', $data);
