    ...
    <table width="100%" cellspacing="0">
      <thead>
		<tr>
		  ...
		  <th align="center"><?php echo $this->fieldInfos['want_money']['name']; ?> </th>
		  <th align="center"><?php echo $this->fieldInfos['want_times']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['valid_money']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['valid_times']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['lasttime_account']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['pay_money']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['pay_times']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['lasttime_pay']['name']; ?></th>
		  <th align="center"><?php echo $this->fieldInfos['unusual_money']['name']; ?></th>
	  ...
	  <?php if (is_array($this->infos) && !empty($this->infos)) { foreach ($this->infos as $info) { ?>
        <tr>
		  ...
		  <td align="center"><?php echo $info['want_money']; ?></td>
		  <td align="center"><?php echo $info['want_times']; ?></td>
		  <td align="center"><?php echo $info['valid_money']; ?></td>
		  <td align="center"><?php echo $info['valid_times']; ?></td>
		  <td align="center"><?php echo $info['lasttime_account']; ?></td>
		  <td align="center"><?php echo $info['pay_money']; ?></td>
		  <td align="center"><?php echo $info['pay_times']; ?></td>
		  <td align="center"><?php echo $info['lasttime_pay']; ?></td>
		  <td align="center"><?php echo $info['unusual_money']; ?></td>
          <td class="text-c">
