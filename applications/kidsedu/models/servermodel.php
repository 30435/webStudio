...
class ServerModel extends CommonModel 
{
	...
	protected function _fieldInfos()
	{
		...
		$fieldInfos['fields'] = array(
			...
			'server_status' => array('name' => '服务器状态', 'infos' => $statusInfos),
			'time_start' => array('name' => '开服时间'),
			'start_maintain' => array('name' => '维护开始时间'),
			'end_maintain' => array('name' => '维护结束时间'),
			'url_maintain' => array('name' => '维护跳转地址'),
		);
		$fieldInfos['fieldChanges'] = array('name', 'server_mark', 'webgame_code', 'listorder', 'ispay', 'server_status', 'time_start', 'start_maintain', 'end_maintain', 'url_maintain');
