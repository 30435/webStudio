...
(1, '公司信息', 'ourinfo', '', 0, 1, '', 'http://webgame.ci.com/index/category?catid=1', 0, '公司信息相关的栏目', '0', '', '', '', 0),
(2, '关于我们', 'gywm', '', 1, 1, '', 'http://webgame.ci.com/index/category?catid=2', 0, '', 'page_aboutus', '', '', '', 0),
(3, '员工关怀', 'yggh', '', 1, 1, '', 'http://webgame.ci.com/index/category?catid=3', 0, '', 'page_aboutus', '', '', '', 0),
(4, '发展历程', 'fzlc', '', 1, 1, '', 'http://webgame.ci.com/index/category?catid=4', 0, '', 'page_aboutus', '', '', '', 0),
(5, '核心价值', 'hxjz', '', 1, 1, '', 'http://webgame.ci.com/index/category?catid=5', 0, '', 'page_aboutus', '', '', '', 0),
(6, '联系我们', 'lxwm', '', 1, 1, '', 'http://webgame.ci.com/index/category?catid=6', 0, '', 'page_aboutus', '', '', '', 0),
(7, '公司新闻', 'news', '', 1, 2, '', 'http://webgame.ci.com/index/category?catid=7', 0, '', 'list', '', '', '', 0),
(8, '诺瓦奇兵', 'nova', '', 0, 2, 'http://nova.ci.com/', 'http://webgame.ci.com/index/category?catid=8', 0, '诺瓦奇兵资讯', 'list_big', '', '', '', 0),
(9, '新闻公告', 'xwgg', '', 8, 2, 'http://nova.ci.com/', 'http://webgame.ci.com/index/category?catid=9', 0, '诺瓦新闻', '0', '', '', '', 0),
...
(18, '知金理念', 'zjln', '', 0, 1, '', 'http://webgame.ci.com/index/category?catid=18', 0, '', 'page_service', '', '', '', 0),
...
(23, '赛尔资讯', 'sezx', '', 0, 2, 'http://seer.ci.com/', 'http://webgame.ci.com/.html', 0, '', '0', '', '', '', 0),
(24, '赛尔新闻', 'sexw', '', 23, 2, '', 'http://seer.ci.com/sezx/.html', 0, '', '0', '', '', '', 0),
(25, '日日日', 'rrr', '', 24, 2, '', '', 0, '', '0', '', '', '', 0),
(26, 'test', 'ttt', '', 24, 0, '', '', 0, '', '0', '', '', '', 0),
(27, '神仙道资讯', 'sxdzx', '', 0, 2, '', '', 0, '', '0', '', '', '', 0),
(28, '游戏2', 'yx', '', 0, 2, '', '', 0, '', '0', '', '', '', 0),
(29, '游戏3', 'rrr', '', 0, 2, 'http://yx.ci.com/', 'http://webgame.ci.com/index.html', 0, '', '0', '', '', '', 0),
...
(1193559, 'shenxd', 1, 'aaaaaa', 7, 2, 119, 1379831359, 1380024112, 1379904474, 1380024112);
...
CREATE TABLE IF NOT EXISTS `sw_new` (
...
(3, 7, 'uuuuuuuuuu', 'http://upload.ci.com/passport2013/0911/20130911165102242.jpg', '0是大法官', '大概发色发顺丰', 'http://webgame.ci.com/index/show?id=7_3', 0, 1, 0, 'wangcan', 'diy', 'index', '<p>\r\n	阿萨德发生发的</p>\r\n', 'show', 1378886555, 1379321493, 0, ''),
(2, 7, '方法', '0', 'have keyword', '', 'http://webgame.ci.com/index/show?id=7_2', 0, 1, 0, 'wangcan', '0', '0', '<p>\r\n	ggggg</p>\r\n', '0', 1378867357, 1379321504, 0, ''),
...
CREATE TABLE IF NOT EXISTS `sw_picture` (
...
(1, 'shenxd', 1, 1193559, 'aaaaaa', '', 1379831359, '20130922', 967530, 12, 950400, 12, 0, 1, 1, 0, 0, 0, '1'),
(2, 'shenxd', 1, 1193559, 'aaaaaa', '', 1379904474, '20130923', 1040645, 13, 1036800, 13, 0, 1, 1, 0, 0, 0, '1'),
(3, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380023938, '20130924', 1160109, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(4, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024056, '20130924', 1160227, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(5, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024057, '20130924', 1160228, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(6, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024057, '20130924', 1160228, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(7, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024058, '20130924', 1160229, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(8, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024058, '20130924', 1160229, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0'),
(9, 'shenxd', 1, 1193559, 'aaaaaa', '', 1380024112, '20130924', 1160283, 14, 1123200, 14, 0, 0, 0, 0, 0, 0, '0');
...
CREATE TABLE IF NOT EXISTS `sw_server` (
...
CREATE TABLE IF NOT EXISTS `sw_spage` (
...
INSERT INTO `sw_spage` (`id`, `catid`, `title`, `username`, `content`, `template`, `inputtime`, `updatetime`) VALUES
(1, 3, '为武器而非v', 'wangcan', '<p>\r\n	阿萨德法师法师打发士大夫</p>\r\n', '', 0, 1378867876),
(2, 4, '发生的发生的发生的发生地方', 'wangcan', '<p>\r\n	阿萨德发生的发生的发生的发生的发生地方<img alt="" src="http://upload.ci.com/content/img/2013091188117.jpg" style="width: 384px; height: 302px;" /></p>\r\n', '', 0, 1378865988),
(8, 2, '阿萨德发顺丰', 'wangcan', '<p>\r\n	阿萨德发顺丰大幅得得得大是大非<img alt="" src="http://upload.ci.com/content/img/2013091178691.jpg" style="width: 862px; height: 478px;" /></p>\r\n', '', 0, 1378866171),
...
CREATE TABLE IF NOT EXISTS `sw_webgame` (
