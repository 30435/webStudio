...
(4, '发展历程', 'fzlc', 'ourinfo/', '', 1, 1, 'http://webgame.kids.com/index/category?catid=4', 0, '', 'page_aboutus', '', '', '', 'biglist_html', 1),
(5, '核心价值', 'hxjz', 'ourinfo/', '', 1, 1, 'http://webgame.kids.com/index/category?catid=5', 0, '', 'page_aboutus', '', '', '', 'biglist_html', 1),
(6, '联系我们', 'lxwm', 'ourinfo/', '', 1, 1, 'http://webgame.kids.com/index/category?catid=6', 0, '', 'page_aboutus', '', '', '', 'biglist_html', 1),
(7, '公司新闻', 'news', 'ourinfo/', '', 1, 2, 'http://webgame.kids.com/index/category?catid=7', 0, '', 'list', '', '', '', 'biglist_html', 1),
(8, '诺瓦奇兵', 'nova', '/', '', 0, 2, 'http://webgame.kids.com/index/category?catid=8', 0, '诺瓦奇兵资讯', 'list_big', '', '', '', 'biglist_html', 1),
(9, '新闻公告', 'xwgg', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=9', 0, '诺瓦新闻', '0', '', '', '', '0', 0),
(10, '诺瓦宠物', 'nwcw', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=10', 0, '诺瓦宠物', '0', '', '', '', '0', 0),
(11, '宠物练级', 'cwlj', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=11', 0, '宠物练级', '0', '', '', '', '0', 0),
(12, '宠物捕捉', 'cwbz', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=12', 0, '宠物捕捉', '0', '', '', '', '0', 0),
(13, '游戏攻略', 'yxgl', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=13', 0, '游戏攻略', '0', '', '', '', '0', 0),
(14, '诺瓦问答', 'nwwd', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=14', 0, '诺瓦问答', '0', '', '', '', '0', 0),
(15, '新手指南', 'xszn', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=15', 0, '新手指南', '0', '', '', '', '0', 0),
(16, '诺瓦图片', 'nwtp', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=16', 0, '诺瓦图片', '0', '', '', '', '0', 0),
(17, '精彩视频', 'jcsp', 'nova/', '', 8, 2, 'http://webgame.kids.com/index/category?catid=17', 0, '精彩视频', '0', '', '', '', '0', 0),
(18, '知金理念', 'zjln', '/', '', 0, 1, 'http://webgame.kids.com/index/category?catid=18', 0, '', 'page_service', '', '', '', '0', 1),
(19, '父母须知', 'fmxz', 'zjln/', '', 18, 1, 'http://webgame.kids.com/index/category?catid=19', 0, '', 'page_service', '', '', '', '0', 0),
(20, '儿童健康上网', 'jksw', 'zjln/', '', 18, 1, 'http://webgame.kids.com/index/category?catid=20', 0, '', 'page_service', '', '', '', '0', 0),
(21, '绿色宣言', 'lsxy', 'zjln/', '', 18, 1, 'http://webgame.kids.com/index/category?catid=21', 0, '', 'page_service', '', '', '', '0', 0),
(22, '服务条款', 'fwtk', 'zjln/', '', 18, 1, 'http://webgame.kids.com/index/category?catid=22', 0, '', 'page_service', '', '', '', '0', 0);
...
CREATE TABLE IF NOT EXISTS `kw_member` (
  ...
  `play_num` smallint(5) unsigned NOT NULL,
  `pay_num` smallint(5) unsigned NOT NULL COMMENT '充值次数',
  `pay_money` float NOT NULL COMMENT '充值金额',
...
CREATE TABLE IF NOT EXISTS `kw_webgame` (
  ...
  `description` varchar(500) NOT NULL COMMENT '游戏描述',
  `brief` varchar(200) DEFAULT NULL COMMENT '游戏简介',
  `pic_small` varchar(200) NOT NULL COMMENT '游戏小图',
  `pic_middle` varchar(200) NOT NULL COMMENT '游戏中图',
  `pic_big` varchar(200) NOT NULL COMMENT '游戏大图',
  `url_home` varchar(100) NOT NULL COMMENT '游戏官网地址',
  `url_server` varchar(100) NOT NULL COMMENT '游戏服务器列表地址',
  `url_bbs` varchar(120) NOT NULL COMMENT 'BBS地址',
  `coin_name` char(15) NOT NULL COMMENT '游戏币名称',
  `coin_unit` char(10) NOT NULL COMMENT '游戏币单位',
...
(4, 'me', '自主占位2', '精心打造中，一出江湖，谁与争锋', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币4', '个', 100, 2, '1', 1, '1', '', 1377426360, 1377858360),
(5, 'our', '自主占位3', '正在精心打造，就快打造好了', NULL, 'http://upload.kids.com/passport2013/0828/20130828182405772.jpg', 'http://upload.kids.com/passport2013/0828/20130828182415985.jpg', 'http://upload.kids.com/passport2013/0828/20130828182438223.png', 'http://nova.kids.com/', '', '', '瓦币5', '个', 10, 1, '1', 1, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(6, 'selfs', '自主占位2', '精心打造中，明天就上线', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币6', '个', 100, 2, '1', 1, '1', '', 1377426360, 1377858360),
(7, 'seer', '赛尔号', '正在精心打造，敬请期待', NULL, 'http://upload.kids.com/content/seer.jpg', 'http://upload.kids.com/content/seer.jpg', 'http://upload.kids.com/content/seer.jpg', 'http://seer.kids.com/', '', '', '瓦币3', '个', 10, 1, '1', 2, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(8, 'their', '运营2', '精心打造中，一出江湖，谁与争锋', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币4', '个', 100, 2, '1', 2, '1', '', 1377426360, 1377858360),
(9, 'others', '运营3', '正在精心打造，就快打造好了', NULL, 'http://upload.kids.com/passport2013/0828/20130828182405772.jpg', 'http://upload.kids.com/passport2013/0828/20130828182415985.jpg', 'http://upload.kids.com/passport2013/0828/20130828182438223.png', 'http://nova.kids.com/', '', '', '瓦币5', '个', 10, 1, '1', 2, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(10, 'otherr', '运营4', '精心打造中，明天就上线', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币6', '个', 100, 2, '1', 2, '1', '', 1377426360, 1377858360),
(11, 'shenxd', '神仙道', '正在精心打造，敬请期待', NULL, 'http://upload.kids.com/content/shenxd.jpg', 'http://upload.kids.com/content/shenxd.jpg', 'http://upload.kids.com/content/shenxd.jpg', 'http://shenxd.kids.com/', '', '', '金币', '个', 10, 1, '1', 3, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(12, 'www', '普通网游2', '精心打造中，一出江湖，谁与争锋', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币4', '个', 100, 2, '1', 3, '1', '', 1377426360, 1377858360),
(13, 'eee', '普通网游3', '正在精心打造，就快打造好了', NULL, 'http://upload.kids.com/passport2013/0828/20130828182405772.jpg', 'http://upload.kids.com/passport2013/0828/20130828182415985.jpg', 'http://upload.kids.com/passport2013/0828/20130828182438223.png', 'http://nova.kids.com/', '', '', '瓦币5', '个', 10, 1, '1', 3, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(14, 'bbb', '普通网游4', '精心打造中，明天就上线', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币6', '个', 100, 2, '1', 3, '1', '', 1377426360, 1377858360),
(15, 'wwe', '普通网游5', '正在精心打造，敬请期待', NULL, 'http://upload.kids.com/passport2013/0828/20130828182405772.jpg', 'http://upload.kids.com/passport2013/0828/20130828182415985.jpg', 'http://upload.kids.com/passport2013/0828/20130828182438223.png', 'http://nova.kids.com/', '', '', '瓦币3', '个', 10, 1, '1', 3, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(16, 'wwb', '普通网游6', '精心打造中，一出江湖，谁与争锋', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币4', '个', 100, 2, '1', 3, '1', '', 1377426360, 1377858360),
(17, 'wee', '普通网游7', '正在精心打造，就快打造好了', NULL, 'http://upload.kids.com/passport2013/0828/20130828182405772.jpg', 'http://upload.kids.com/passport2013/0828/20130828182415985.jpg', 'http://upload.kids.com/passport2013/0828/20130828182438223.png', 'http://nova.kids.com/', '', '', '瓦币5', '个', 10, 1, '1', 3, '1', 'http://nova.kids.com/', 1377164880, 1377769680),
(18, 'eeb', '普通网游8', '精心打造中，明天就上线', NULL, 'http://upload.kids.com/passport2013/0828/20130828182801991.jpg', 'http://upload.kids.com/passport2013/0828/20130828182810323.png', 'http://upload.kids.com/passport2013/0828/20130828182818206.png', 'http://navo.kids.com/', '', '', '瓦币6', '个', 100, 2, '1', 3, '1', '', 1377426360, 1377858360);
